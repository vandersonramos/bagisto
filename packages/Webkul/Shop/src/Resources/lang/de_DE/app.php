...
return [
    ...
    'home' => [
        ...
        'featured-products' => 'Vorgestellten Produkte',
        'new-products' => 'Neue Produkte',
        'verify-email' => 'Überprüfen Sie Ihre E-Mail',
    ...
    'mail' => [
        ...
        'forget-password' => [
            'dear' => 'Sehr geehrter :name',
            'info' => 'Sie erhalten diese E-Mail, weil wir für Ihr Konto eine Anfrage zum Zurücksetzen des Passworts erhalten haben',
            'reset-password' => 'Passwort zurücksetzen',
            'final-summary' => 'Wenn Sie keine Kennwort Zurücksetzen angefordert haben, ist keine weitere Aktion erforderlich',
            'thanks' => 'Vielen Dank!'
        ]
    ],

    'webkul' => [
        'copy-right' => '© Urheberrecht :year Webkul Software, Alle Rechte vorbehalten',
    ],
    ...
    'response' => [
        ...
        'submit-success' => ':name erfolgreich gesendet'
    ],
];